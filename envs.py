...
#         #self.arcenv = gym.make('ARCLE/O2ARCv2Env-v0', render_mode='ansi',data_loader= ARCLoader(), max_grid_size=(30,30), colors=10, max_episode_steps=None)
#         self.arcenv = gym.make('ARCLE/O2ARCv2Env-v0', render_mode='ansi', data_loader=MiniARCLoader(), max_grid_size=(30,30), colors=10, max_episode_steps=None)
#         self.tasks = tasks
#         self.set_task_idx(0)
